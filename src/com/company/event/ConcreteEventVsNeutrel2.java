...
import com.company.actualPokemons.Neutrel2;
...
/*Evenimentul vsNeutrel2*/
public class ConcreteEventVsNeutrel2 implements EventStrategy {
    ...
    public boolean executeEvent(Antrenor antrenor1, Antrenor antrenor2) {
        ...
        Neutrel2 neutrel2 = (Neutrel2) pokemonFactory.createPokemon("Neutrel2");
        ...
        Duel duel1 = new Duel(pokemon1, neutrel2.clone());
        ...
        Duel duel2 = new Duel(pokemon2, neutrel2.clone());
